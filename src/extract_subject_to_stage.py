...
def main():
    try:
        truncate_table = """TRUNCATE TABLE "STAGE_PASSEI_DIRETO".stg_dim_subjects"""
        ...
        logger.debug("Truncate Table stg_dim_subjects")

        records_list = get_file('subjects.json')
        logger.debug('Retrieved {} records from file "subject.json"'.format(len(records_list)))
